...
Median is a personal media diary and wishlist manager for movies, TV shows, and books (with other types of media potentially to come in future phases). It lets users log what they've watched/read, track what they want to consume, and manage curated lists — alone or collaboratively with others.
...
- Link to full diary page *(TODO: feature design needed — [MDN-1](./backlog/tasks/mdn-1%20-%20feature-design-for-full-diary-page.md))*
